...
Additional modes: - `--stress` — adversarial referees for pre-submission battle testing - `--r2` — R&R second round with referee memory - Max 3 rounds, then the editor's patience runs out
